...
This includes the basic version of the digital receipt as well as the Give-away and Promotion version. 
...
## Digital receipt functionalities
First production ready functionalities of the digital receipt (April 2023):
-	Configuration of logo and address for the digital receipt in the fiskaltrust.Portal for the markets AUT, GER, FRA
